  ...
  return (
    <section id="contacto" className="relative py-28 overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 100%, rgba(106,13,173,0.2) 0%, transparent 70%)",
        }}
      />
      <div
        className="orb w-80 h-80 left-1/2 -translate-x-1/2 top-0 animate-glow"
        style={{ background: "rgba(255,77,141,0.1)" }}
      />

      <div
        ref={ref}
        className="section-hidden max-w-4xl mx-auto px-6 text-center"
      >
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <div
            className="w-8 h-px"
            style={{
              background: "linear-gradient(to left, transparent, #FF4D8D)",
            }}
          />
        </div>
        ...
        >
          ...
          <br />
          amazing together
          <Heart size={24} className="inline-block text-pink-500" />
        </h2>

        <p
          className="text-base mb-14 max-w-lg mx-auto"
          style={{ color: "#9490b0", lineHeight: 1.8 }}
        >
          I'm always open to internships, collaborations, and opportunities to
          learn and grow. Feel free to get in touch!
        </p>
        ...
        <p
          className="mt-16 text-xs flex items-center justify-center gap-1"
          style={{ color: "#5a5770", fontFamily: "JetBrains Mono, monospace" }}
        >
          © {new Date().getFullYear()} Yadhira Saavedra · Aspiring Data Analyst
