  ...
  return (
    <header
      ...
      style={{
        ...
        borderBottom:
          menuOpen || scrolled ? "1px solid rgba(255,255,255,0.06)" : "none",
      }}
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          ...
          <span className="text-white/40 ml-1 font-light text-sm">
            ·portfolio
          </span>
        </button>
          ...
          {links.map((l) => (
            <button
              ...
              style={{
                ...
                background:
                  active === l.href ? "rgba(255,77,141,0.08)" : "transparent",
              }}
            >
              {l.label}
              {active === l.href && (
        ...
        <button
          className="md:hidden p-2 rounded-full transition-all duration-300 hover:bg-white/5"
        ...
        >
          {menuOpen ? (
            <X
              size={24}
              strokeWidth={2.3}
              className="text-white/80 hover:text-[#FF4D8D] transition-colors"
            />
          ) : (
            <Menu
              size={24}
