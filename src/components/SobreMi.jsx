...
const traits = [
  { icon: <BarChart2 size={16} />, label: "Data Analytics" },
  { icon: <Palette size={16} />, label: "UX/UI Design" },
  { icon: <Globe size={16} />, label: "Web Development" },
  { icon: <Cpu size={16} />, label: "Systems Engineering" },
];
...
export default function SobreMi() {
  ...
  return (
    <section id="sobre-mi" className="relative py-28 overflow-hidden">
      <div
        className="orb w-80 h-80 -left-40 top-0 animate-glow"
      ...
      <div ref={ref} className="section-hidden max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Hello, I'm <span className="grad-text">Yadhira</span>
            </h2>

            <div
              className="space-y-4 text-base"
              style={{ color: "#9490b0", lineHeight: 1.85 }}
            >
              <p>
                I am an{" "}
                ...
                ­ passionate about
                <span style={{ color: "#c084fc" }}> web development</span>,
                <span style={{ color: "#f9a8d4" }}> data analytics</span>, and
                <span style={{ color: "#c084fc" }}> UX/UI design</span>.
              </p>
              ...
              <p>
                ...
                <span style={{ color: "#f0eeff" }}>
                  {" "}
                  React, Java, Spring Boot, MySQL, and Figma
                </span>
                , gaining experience in web development, database management,
                and user-centered design.
              </p>

              <p>
                I am currently expanding my knowledge in
                <span style={{ color: "#c084fc" }}> data analytics</span> by
                learning SQL, Python, and Power BI, while continuously strengthening my
              ...
              >
                // Curious mind · Continuous learning · Professional growth
              </p>
            </div>
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="w-72 h-72 rounded-full border border-fuchsia-400/10 animate-spin-slow"
                style={{ borderColor: "rgba(255,77,141,0.1)" }}
              />
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="w-52 h-52 rounded-full border border-purple-500/10 animate-spin-slow"
                style={{
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${s.pct}%`,
                            background:
                              "linear-gradient(to right, #FF4D8D, #6A0DAD)",
                          }}
                        />
                      </div>
                    </div>
